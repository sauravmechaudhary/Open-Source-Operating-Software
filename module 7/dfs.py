...
Add a method dfs(start) to your MachineNetwork class.
●​
●​
●​
●​
...
Visit machines by going as deep as possible first
Return a list showing the order of visited machines
If the machine does not exist, print an error and return an empty list​
Another hint:
Stack behavior with a list:​
Add to end: stack.append(x)​
Remove from end: stack.pop()​
